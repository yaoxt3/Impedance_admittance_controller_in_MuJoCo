...
# Trajectory generator code from Peter Corke's robotic toolbox
...
class Trajectory:
    ...
    def plot(self, block=False, plotargs=None, textargs=None):
        ...
        # plot velocity
        ax = plt.subplot(self.n_plots, 1, 2)
        ...
        # plot acceleration
        ax = plt.subplot(self.n_plots, 1, 3)
...
if __name__ == "__main__":
    ...
    # tg = ctraj(SE3.Rand(), SE3.Rand(), np.arange(0, 10), (1, 10))
    # tg.plot()